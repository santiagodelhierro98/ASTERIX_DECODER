        ...
        void ClickDataGrid(object sender, RoutedEventArgs e) // When we click over a clickable cell
        {
            ...
            if (category == 21)
            {
                ...
                if (cat == 21)
                {
                    ...
                    if (Col_Num == 42 && pack.TMRV_HP != null)
                    {
                    ...
                    if (Col_Num == 45 && pack.Data_Ages != null)
                    {
